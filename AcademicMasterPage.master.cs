...
public partial class AcademicMasterPage : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            SqlCommand cmd2 = new SqlCommand("SELECT * FROM Hoca Where Hoca.Id=" + ((Hoca)Session["AktifKullanici"]).Id, con);
