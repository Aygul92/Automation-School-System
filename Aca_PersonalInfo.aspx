<%@ Page Title="" Language="C#" MasterPageFile="~/AcademicMasterPage.master" AutoEventWireup="true" CodeFile="Aca_PersonalInfo.aspx.cs" Inherits="Academic_Default" %>
                            ...
                            <table class="table table-user-information">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="reg" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Home Address</td>
                                        <td>
                                            <asp:Label ID="adres" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                        <td>
