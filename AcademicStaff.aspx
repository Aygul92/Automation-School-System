<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="AcademicStaff.aspx.cs" Inherits="Default4" %>
                ...
                <div class="auto-style1">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <span class="glyphicon glyphicon-list"></span>Your Techers 
                        <div class="pull-right action-buttons">
                        </div>
                        </div>
                        <div class="panel-body">

                            <asp:Repeater ID="HocaAdi" runat="server">
                                <ItemTemplate>
