<%@ Page Title="" Language="C#" MasterPageFile="~/AcademicMasterPage.master" AutoEventWireup="true" CodeFile="Takvim.aspx.cs" Inherits="Default4" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="bootstrap-3.3.7-dist/css/takvim.css" rel="stylesheet" />
    <style type="text/css">
        .auto-style1 {
            width: 1111px;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cplPageContents" runat="Server">
    <div class="container theme-showcase" style="width: 70%; margin-left: 331px">
        <h1 class="auto-style5">Calendar</h1>
